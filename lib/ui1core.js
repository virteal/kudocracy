...
function format_change( change, page_name, twitter_style, array, at_tail ){
  ...
  if( type === "Comment" ){
    ...
    if( params.orientation ){
      ...
      msg += emojied( params.orientation );
    }else{
    ...
    var sub_msg 
    = icon( "delegation" ) + " " + i18n( "delegation" )
    + " " + link_to_delegation_page( delegation )
    + " " + link_to_page( "propositions", str_tags, str_tags );
