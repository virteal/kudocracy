...
// client side
  ...
  = '<div class="hide_button_icon">x</div>';
...
// options: with_twitter, compact
  ...
  var buf = [
    ...
    '<div class="vote_menu_core', compact ? "" : ' hide_button', '">',
  ...
  if( Session.current.can_script ){
    buf.push(
      ...
      '<div class="vote_menu_more kudo_collapse hide_button">'
    );
  }else{
    buf.push( "<div>" );
  }
  ...
  buf.push( "</div>" ); // vote_menu_more collapse part
  
  buf.push( "</div>" ); // vote_menu_core
...
PageBuilder.prototype.push_title_and_search_form = function( title, hide ){
  ...
  this.push( '<div id="search_box"><div id="search" class="hide_button">' );
...
function page_ballot2( /* page_name, ...query */ ){
  ...
  this.push( '<br>', '<div class="hide_button">' );
  if( this.session.is_novice ){
    this.push_help(
      i18n( 
...
function page_index( page_name ){
  ...
  var session = this.session;
  var searching_domains = session.filter.indexOf( " #domain ") !== -1;
  ...
  this.push(
    '<div class="twitter_style">',
    '<div id="propositions_list" class="hide_button">',
...
// Focus on one proposition
  ...
  if( session.can_script && proposition.result.total() ){
    buf.push( '<br><div id="orientation_chart_div" class="hide_button chart_pie"></div>' );
  }
