  ...
  Ephemeral.each( tags, function( tag ){
    ...
    if( total ){
      ...
      if( count_for > count_disagree ){
        ...
        emojied_result = emojied( "agree" )
      }else{
        result_percent 
        = Math.round( ( count_disagree / result_total ) * 1000 ) / 10;
        emojied_result = emojied( "disagree" );
      }
...
function page_help(){
  ...
  if( session.lang !== "fr" ){
    msg.push(
      ...
      ' propositions associated to hashtags ',
  ...
  // French
    ...
    msg.push(
      ...
      ' associ&eacute;es &agrave; des hashtags',
      ...
      'Sur des sujets, ',
      'associ&eacute;es &agrave; des hastags',
      ...
      '<li>Les propositions sont class&eacute;es par sujet selon des hashtags.</li>',
...
function emojied_result( result ){
  ...
  ||  result_orientation === Vote.disagree
    ...
    if( result.agree() > result.disagree() ){
      ...
      emojied_text = emojied( "agree" )
    }else{
      percent = Math.round( ( result.disagree() / total ) * 1000 ) / 10;
      emojied_text = emojied( "disagree" );
    }
...
// Focus on one proposition
  ...
  if( tmp = proposition.persona() ){
    buf.push( l( "by" ), " ", link_to_persona_page( tmp ) );
  }
