...
PageBuilder.prototype.push_title = function( title, not_compact ){
  ...
  var filter_label = Session.current.full_query();
  if( filter_label ){
...
// or a tagging action from page_proposition when visitor add tags
  ...
  var is_tagging   = ( name === "Tag"      || name === i18n( "Tag"      ) );
  var is_detagging = ( name === "Untag"    || name === i18n( "Untag"    ) );
  var is_search    = ( name === "Search"   || name === i18n( "Search"   ) );
  var is_query     = ( name === "Query"    || name === i18n( "Query"    ) );
  var is_delegate  = ( name === "Delegate" || name === i18n( "Delegate" ) );
