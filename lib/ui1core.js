...
// Also check local storage capabilities, also saved in a cookie.
  ...
  && supports_local_storage()
    ...
    cookie = "kudo_can_local_storage=true";  // session cookie, no max-age
    // console.log( "set can_local_storage cookie", cookie );
    document.cookie = cookie;
  }
  if( window.kudo_ctx.can_script === true )return;
  var cookie = "kudo_can_script=true";
  // console.log( "set can_script cookie", cookie );
  document.cookie = cookie;
