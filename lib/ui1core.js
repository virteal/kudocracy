...
function filter_change_links( tag_set, dont_hide ){
  ...
  tag_set.each( function( label ){
    ...
    if( display ){
      ...
      buf.push( c > 0 ? '<span class="badge">' + c + '</span>' : "", " " );
    }
  });
...
// This is the "public" aspect of a persona
  ...
  if( twitter ){
    this.push(
      ...
      !twitter.verified ? "" : ' <img src="' + 'https://si0.twimg.com/help/1307051362_737' + '"/>',
...
"This page lists informations about a person, her votes, her delegations (received and given), etc."
  ...
  this.push(
    '<br><br><a href="https://twitter.com/', persona.label,
...
http_repl_commands.login = function( /* name, authentication, alias, more */ ){
  ...
  if( alias ){
    ...
    if( old_alias ){
      // Hack to clear alias: use _ alone
      if( alias === "_" ){ alias = ""; }
      text = text.replace( old_alias.replace( / /g, "_" ), alias );
    }else{
