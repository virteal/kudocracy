...
// The private page of a persona
  ...
  if( persona.is_domain() ){
    ...
    this.push(
      ...
      '<a href="?kudo=', persona.label.substring( 1 ),
...
function page_domain( page_name ){
  ...
  if( visitor.label.substring( 1 ) !== Config.domain ){
    this.push(
      ...
      '<h2><a href="?kudo=', visitor.label.substring( 1 ),
      '&page=propositions">', 
      visitor.label,
      '</a></h2>',
      '<br><br>'
...
function page_badges(){
  ...
  .open_div( "badges_generator" )
    ...
    .push(
      ...
      ' spellcheck=false onfocus="this.focus();this.select()"',
      ' readonly="readonly"',
      '>...</textarea>'
    ).br()
...
function page_badge( /* page_name, etc */ ){
  ...
  // If not found, try with a # for tags
  if( !proposition && proposition_name[ 0 ] !== "#" ){
    proposition = Topic.find( "#" + proposition_name );
    if( proposition ){
      proposition_name = "#" + proposition_name;
      if( !no_icon ){
        title = l( proposition_name ).substring( 0, 24 );
      }
    }
  }
  ...
  if( !no_icon ){
    this.push(
      '<a target="_blank" id="badge-domain" href="/main?kudo=', domain,
