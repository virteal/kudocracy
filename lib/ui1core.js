...
function link_to_delegation_page( agent, tags ){
  ...
  return msg + "&nbsp" + link_to_persona_page( agent );
}
...
function page_header( left, center, right, current_page ){
  ...
  var built_left = link_to_page( "index" );
...
PageBuilder.prototype.push_delegations = function( persona ){ 
  ...
  var can_delegate = visitor !== persona;
...
// propositions, filtered.
  ...
  if( visitor ){
    msg1 += " " 
    + link_to_page( "propose", "", i18n( "new proposition" ) ) + ".";
  }
  msg1 += '<br><br>';
...
function page_leaders( page_name, optional_proposition_name ){
  ...
  this.set(
    ...
    : page_header_left( _, _, _, "leaders" )
  );
