...
function format_change( change, page_name, twitter_style, array, at_tail ){
  ...
  if( type === "Comment" ){
    ...
    if( twitter_style ){
      ...
      += " #" + link_to_twitter_tag( proposition.label )
      +  '&nbsp;<dfn>'  
      +  link_to_proposition_page( proposition, icon( "zoom-in") )
      +  '</dfn>';
    }else{
    ...
    msg += "&nbsp;<dfn>" 
    + link_to_wiki_icon( proposition.label ) 
    + "</dfn>";
    if( !twitter_style ){
      msg += " " + link_to_twitter_tag( proposition.label, icon( "twitter" ) );
    }
...
function page_index( page_name ){
  ...
  if( !is_main ){
    ...
    this.set(
      ...
      '<div style="margin:auto; max-width:1040px;">',
