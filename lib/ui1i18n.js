...
module.exports = table = {
  ...
  _: {
    ...
    "i-proposition":   '<span class="glyphicon glyphicon-link"></span>',
    ...
    "i-twitter":       '<i class="fa fa-twitter twitter_blue"></i>',
    ...
    "i-show":         '<span class="show_button_icon glyphicon glyphicon-fullscreen"></span>',
    "i-delegation":   '<span class="glyphicon glyphicon-user"></span>',
  ...
  fr: {
    ...
    "with a recent activity": "avec une activité récente",
    "blank or protest votes": "blancs ou protestations",
    "without a vote from you": "sans vote de votre part",
    "with a for/against equality": "avec une égalité pour/contre",
    ...
    "select desired tags: ":
      "sélectionnez les hashtags désirés : ",
