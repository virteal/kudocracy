...
module.exports = table = {
  ...
  fr: {
    ...
    "tags with a single proposition":
      "tags avec une seule proposition",
    ...
    "This page lists indirect votes via delegates and associated tags.":
      "Cette page affiche des votes indirects via des délégués et des tags associés.",
    ...
    "This page lists your delegations to others who vote for you on propositions that match some specified tags.":
      "Cette page affiche vos délégations à d'autres qui votent pour vous sur des propositions dot&eacute;es de certains tags.",
