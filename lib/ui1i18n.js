...
module.exports = table = {
  ...
  _: {
    ...
    "i-twittrust":     '<i class="fa fa-twitter twitter_bw"></i>',
  ...
  fr: {
    ...
    "This page lists informations about a person, her votes, her delegations (received and given), etc.":
      "Cette page affiche des informations au sujet d'une personne, de ses votes, de ses amiti&eacute;s (données et reçues), etc.", // délégations
