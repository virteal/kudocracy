...
module.exports = table = {
  ...
  _: {
    ...
    "propositions": '<span class="glyphicon glyphicon-search" aria-hidden="true"></span>',
    //"Tags": '<span class="glyphicon glyphicon-tags" aria-hidden="true"></span>',
    "tag": '<span class="glyphicon glyphicon-tag" aria-hidden="true"></span>',
    "tags": '<span class="glyphicon glyphicon-tags" aria-hidden="true"></span>',
    "help": '<span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>',
    "you": '<span class="glyphicon glyphicon-user" aria-hidden="true"></span>',
    "login": '<span class="glyphicon glyphicon-user" aria-hidden="true"></span>',
    "delegates": '<span class="glyphicon glyphicon-user" aria-hidden="true"></span>',
    "persona": '<span class="glyphicon glyphicon-user" aria-hidden="true"></span>',
    "votes": '<span class="glyphicon glyphicon-comment" aria-hidden="true"></span>',
    "ballot": '<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>',
    "computed": '<span class="glyphicon glyphicon-filter" aria-hidden="true"></span>'
  },
