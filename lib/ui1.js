...
function page_leaders( page_name ){
  ...
  this.set( page_style( "delegations" ), page_header_left() );
  ...
  var tag_set = this.push_title_and_search_form( "Delegates" );
  ...
  Ephemeral.each( propositions, function( proposition ){
    ...
    var c = proposition.result.indirect();
    other_count -= c;
...
// Focus on one proposition
  ...
  var buf_voters = [];
  buf_voters.push( "<br><br><h2>", i18n( "Voters" ), "</h2><br>" );
  ...
  if( count_indirect_votes ){
    ...
    var abuf = [];
    abuf.push( "<br><br><h2>", i18n( "Delegates" ) +"</h2><br><br>" );
