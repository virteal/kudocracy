...
// The private page of a persona
  ...
  this.set(
    ...
    page_header_right(
      ...
      + " " + link_to_persona_page( persona, "public" )
    )
  );
...
function page_leaders( page_name ){
  ...
  // Display each agent
  this.push( "<br><br><br><h2>Agents</h2><br>" );
  ...
  all_tag_ids.forEach( function( tags ){
    ...
    var len = list.length;
    // Display 7 most important agents
    for( var ii = 0 ; ii < len && ii < 7 ; ii++ ){
      agent_id = list[ ii ];
      ratio = Math.round( 1000 * ( 
        counts[ agent_id ]
  ...
  if( last_vote ){
    this.push(
      "<br><br><h2>Summary</h2><br>",
      "<br>proposition ", count_propositions,
      "<br>agent ", agent_ids.length,
      "<br>tag ", all_tag_ids.length,
      "<br>direct vote ", count_direct_votes,
      "<br>indirect vote ",count_votes, 
      "<br>since ", time_label( last_vote.snaptime ),
      "<br><br>"
    );
  }
