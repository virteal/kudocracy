...
TrustActor.get_ranked = function( max, depth ){
  ...
  ||  depth === "rate"
    ...
    other_list = TrustActor.get_ranked( 1000, 1 ).actors;
  }
  ...
  for( var ii = 0 ; ii < list.length ; ii++ ){
    ...
    // Criteria, ratio of pagerank over twitter followers
    }else if( depth === "efficiency" ){
      actor.score = actor.followers_rank / actor.pagerank_rank;
    ...
    if( false && user.followers_count < 10 )continue;
