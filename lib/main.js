...
Topic.prototype.add_comment = function( comment ){
  ...
  if( comment.persona && comment.persona.is_abuse() )return this;
  ...
  if( !this.comment()
  || comment.persona === this.comment().vote.persona
  ){
...
Topic.prototype.get_comment = function(){
  ...
  if( !Persona.valid( comment.persona ) )return null;
  if( comment.persona.is_abuse() )return null;
  return comment;
};
