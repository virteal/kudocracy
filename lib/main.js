...
// Note: Persona::set_volatile_alias() is used to import aliases from twitter.
  ...
  if( typeof alias !== "undefined" )return alias || dflt;
...
Topic.prototype.computed_tags = function( persona ){
  ...
  var count_persona = Persona.all._count;
...
Result.prototype.is_referendum = function(){
  return this.total() * 100 > Persona.all._count && this.total() > 1;
};
