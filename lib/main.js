...
function DelegationFilter( tags ){
  ...
  var id = ids.join( "." );
  var found = DelegationFilter.all[ id.toLowerCase() ];
  if( found )return found;
  this.label = id;
  this.id = id.toLowerCase();
  this.count_votes = 0;
  this._delegation_expertizes = [];
  DelegationFilter.all[ this.id ] = this;
  return this;
}
